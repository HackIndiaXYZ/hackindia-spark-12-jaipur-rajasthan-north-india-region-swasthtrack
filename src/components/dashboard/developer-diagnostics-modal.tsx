      ...
      <div className="space-y-4 text-xs">
        ...
        <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-3.5 space-y-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-xs text-slate-700">
            ...
            <div>
              ...
              <span className="font-semibold text-emerald-700">Active (Isolated)</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-2.5">
          <div className="rounded-xl border border-slate-200 bg-white p-3">
            <span className="text-2xs uppercase font-semibold text-slate-400">Inference Time</span>
            <p className="mt-1 text-base font-bold text-slate-900">
              {diagnostics.averageInferenceLatencyMs} ms
            </p>
            <span className="text-2xs text-emerald-600 font-semibold">Budget Compliant</span>
          </div>

          <div className="rounded-xl border border-slate-200 bg-white p-3">
            <span className="text-2xs uppercase font-semibold text-slate-400">Intelligence Reliability</span>
            <p className="mt-1 text-base font-bold text-indigo-950">
              Experimental
            </p>
            <span className="text-2xs text-slate-500">10/10 Lab Scenarios</span>
          </div>

          <div className="rounded-xl border border-slate-200 bg-white p-3">
            <span className="text-2xs uppercase font-semibold text-slate-400">User Feedback</span>
            <p className="mt-1 text-base font-bold text-slate-900 flex items-center gap-1">
              <ThumbsUp className="h-3.5 w-3.5 text-emerald-600" />
              {diagnostics.feedbackStats.positive} / {diagnostics.feedbackStats.negative}
            </p>
            <span className="text-2xs text-slate-500">Pos / Neg</span>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-indigo-200 bg-gradient-to-r from-indigo-50 to-sky-50 p-3.5 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <Link
            href="/simulation-lab"
            onClick={onClose}
            className="inline-flex items-center justify-center gap-1.5 rounded-lg bg-indigo-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-indigo-700 transition-colors shrink-0 shadow-2xs"
          >
            Launch Lab →
          </Link>
        </div>
