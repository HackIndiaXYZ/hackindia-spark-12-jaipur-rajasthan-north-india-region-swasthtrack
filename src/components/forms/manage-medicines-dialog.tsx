        ...
        <div className="space-y-4 max-w-full">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3.5 rounded-2xl border-2 border-emerald-200 bg-emerald-50/70">
            ...
            <button
              ...
              className="w-full sm:w-auto px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 active:scale-97 text-white font-bold text-xs sm:text-sm flex items-center justify-center gap-1.5 shadow-md transition-all cursor-pointer shrink-0"
            >
                ...
                >
                  ...
                  <div className="flex items-center gap-2 shrink-0 self-end sm:self-center">
                    <button
                      ...
                      className="min-h-9 px-3 text-xs font-bold text-slate-800 bg-slate-100 hover:bg-slate-200 border border-slate-300 rounded-xl flex items-center gap-1.5 transition-all cursor-pointer active:scale-97"
                    >
                    ...
                    <button
                      ...
                      className="min-h-9 px-3 text-xs font-bold text-rose-700 bg-rose-50 hover:bg-rose-100 border border-rose-200 rounded-xl flex items-center gap-1.5 transition-all cursor-pointer active:scale-97 disabled:opacity-50"
                    >
