    ...
    <div className="space-y-6 max-w-3xl mx-auto">
      ...
      <Card className="border-emerald-200 bg-gradient-to-br from-emerald-50/60 via-white to-slate-50 p-6 shadow-xs">
        <div className="flex items-start gap-4">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-emerald-600 text-white shadow-sm font-semibold text-lg">
            PK
          </div>
          <div className="space-y-1">
            <h2 className="text-lg font-semibold text-slate-900">Pawan Kumar</h2>
        ...
        <Card className="p-5 border-slate-200 bg-white flex flex-col justify-between">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-semibold text-slate-900">General Support</h3>
            </div>
          ...
          <div className="mt-5 pt-4 border-t border-slate-100">
            <a
              ...
              className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-slate-900 px-4 py-2.5 text-xs font-semibold text-white hover:bg-slate-800 transition-colors shadow-2xs"
            >
              <Mail className="h-3.5 w-3.5" />
              Email Support
            </a>
            <p className="mt-1.5 text-center text-xs text-slate-400 font-mono">
        ...
        <Card className="p-5 border-slate-200 bg-white flex flex-col justify-between">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-semibold text-slate-900">Have a Suggestion?</h3>
            </div>
            <p className="text-xs text-slate-600 leading-relaxed">
          ...
          <div className="mt-5 pt-4 border-t border-slate-100">
            <a
              ...
              className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-600 px-4 py-2.5 text-xs font-semibold text-white hover:bg-emerald-700 transition-colors shadow-2xs"
            >
